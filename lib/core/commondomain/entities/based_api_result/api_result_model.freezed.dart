...
/// Adds pattern-matching-related methods to [ApiResultModel].
extension ApiResultModelPatterns<T> on ApiResultModel<T> {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T data)?  success,TResult Function( ErrorResultModel errorResultEntity)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that.data);case Failure() when failure != null:
return failure(_that.errorResultEntity);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T data)  success,required TResult Function( ErrorResultModel errorResultEntity)  failure,}) {final _that = this;
switch (_that) {
case Success():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T data)?  success,TResult? Function( ErrorResultModel errorResultEntity)?  failure,}) {final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that.data);case Failure() when failure != null:
return failure(_that.errorResultEntity);case _:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Failure<T>&&(identical(other.errorResultEntity, errorResultEntity) || other.errorResultEntity == errorResultEntity));
}
...
@useResult
$Res call({
 ErrorResultModel errorResultEntity
});
...
/// Create a copy of ApiResultModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? errorResultEntity = null,}) {
  return _then(Failure<T>(
errorResultEntity: null == errorResultEntity ? _self.errorResultEntity : errorResultEntity // ignore: cast_nullable_to_non_nullable
as ErrorResultModel,
  ));
}
