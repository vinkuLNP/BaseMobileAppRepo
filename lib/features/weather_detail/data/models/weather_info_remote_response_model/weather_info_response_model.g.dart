...
WeatherInfoResponseModel _$WeatherInfoResponseModelFromJson(
  ...
  coordinateData: CoordinateResponseModel.fromJson(
    json['coord'] as Map<String, dynamic>,
  ),
  weatherDescription: (json['weather'] as List<dynamic>?)
      ?.map(
        (e) =>
            WeatherDescriptionResponseModel.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  ...
  windData: json['wind'] == null
      ? null
      : WindInfoResponseModel.fromJson(json['wind'] as Map<String, dynamic>),
