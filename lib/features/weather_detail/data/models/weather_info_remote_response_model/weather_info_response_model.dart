...
import 'package:clean_architecture/core/utils/helpers/extension_functions/extension_functions.dart';
import 'package:clean_architecture/core/utils/mapper/data_mapper.dart';
import 'package:clean_architecture/features/weather_detail/data/models/weather_info_remote_response_model/clouds_response/clouds_response_model.dart';
import 'package:clean_architecture/features/weather_detail/data/models/weather_info_remote_response_model/coordinate_response/coordinate_response_model.dart';
import 'package:clean_architecture/features/weather_detail/data/models/weather_info_remote_response_model/main_weather_info_response/main_weather_info_response_model.dart';
import 'package:clean_architecture/features/weather_detail/data/models/weather_info_remote_response_model/sunset_sunrise_response/sunset_sunrise_response_model.dart';
import 'package:clean_architecture/features/weather_detail/data/models/weather_info_remote_response_model/weather_description_response/weather_description_response_model.dart';
import 'package:clean_architecture/features/weather_detail/data/models/weather_info_remote_response_model/wind_info_response/wind_info_response_model.dart';
...
import 'package:clean_architecture/features/weather_detail/utils/enums/weather_type_enum.dart';
...
class WeatherInfoResponseModel extends DataMapper<WeatherInfoEntity> {
  ...
  @JsonKey(name: 'coord', fromJson: CoordinateResponseModel.fromJson)
  CoordinateResponseModel? coordinateData;
